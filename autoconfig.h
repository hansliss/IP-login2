...
/* The following macros indicate what header files you have.  Set the
   ...
   do not.  */
#define HAVE_STDDEF_H 0 /* <stddef.h> */
...
#define HAVE_SYS_MOUNT_H 0 /* <sys/mount.h> */
...
#define HAVE_TCPD_H 0 /* tcpd.h - libwrap */

#define HAVE_LIBWRAP 0 /* libwrap.a */
#define HAVE_LIBDL 1
...
#define HAVE_SIZE_T_IN_STDDEF_H 0
...
/* Set HAVE_SIZE_T_IN_TYPES_H to 1 if the type size_t is defined in
   ...
   to 1.  */
#define HAVE_SIZE_T_IN_TYPES_H 0
...
#define HAVE_TIME_T_IN_TIME_H 0
...
/* Set HAVE_TIME_T_IN_TYPES_H to 1 if the type time_t is defined in
   ...
   1.  */
#define HAVE_TIME_T_IN_TYPES_H 0
...
#define HAVE_BSEARCH 0 /* bsrch.o */
#define HAVE_GETLINE 0 /* getlin.o */
#define HAVE_MEMCHR 0 /* memchr.o */
#define HAVE_STRDUP 0 /* strdup.o */
#define HAVE_STRSTR 0 /* strstr.o */
#define HAVE_STRTOL 0 /* strtol.o */
#define HAVE_STRTOUL 0 /* strtou.o */
...
#define HAVE_OPENDIR 0 /* dirent.o */
#define HAVE_DUP2 0 /* dup2.o */
#define HAVE_FTW 0 /* ftw.o */
#define HAVE_REMOVE 0 /* remove.o */
#define HAVE_RENAME 0 /* rename.o */
#define HAVE_STRERROR 0 /* strerr.o */
...
#define GETPWNAM_DECLARATION_OK 0
/* extern struct passwd *getpwuid (); */
#define GETPWUID_DECLARATION_OK 0
/* extern struct group *getgrent (); */
#define GETGRENT_DECLARATION_OK 0
